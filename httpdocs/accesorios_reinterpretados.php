...
<head>
   ...
   <title>Accesorios Reinterpretados | OFK</title>  
</head>
<body>
...
while ($row = mysql_fetch_assoc($sql)) {
    ...
    if (mysql_num_rows($sql2) > 0) {
        ...
        echo "<a class='muebles-class1' href='detalle.php?article=$id'><img id='animation".$id."' data-caption='$caption'   src='$preview_url' width='180px' height='180px'/></a>";
